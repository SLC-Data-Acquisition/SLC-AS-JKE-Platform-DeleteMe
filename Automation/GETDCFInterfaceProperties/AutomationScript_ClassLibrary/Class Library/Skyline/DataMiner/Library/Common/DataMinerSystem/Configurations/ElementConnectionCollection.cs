...
namespace Skyline.DataMiner.Library.Common
{
	...
	public class ElementConnectionCollection
	{
		...
		internal void Clear()
		{
			...
			{
				ConnectionSettings connectionSetting = (ConnectionSettings)connection;
		...
		internal void UpdatePortInfo(ElementPortInfo[] portInfos,bool isCompatibilityIssueDetected)
		{
			...
			{
				ConnectionSettings settings = (ConnectionSettings)connections[i];
		...
		internal IEnumerable<ElementPortInfo> CreatePortInfo(bool isCompatibilityIssueDetected)
		{
			...
			for (int i = 0; i < connections.Length; i++)
			{
				...
				ConnectionSettings connection = (ConnectionSettings)connections[i];
